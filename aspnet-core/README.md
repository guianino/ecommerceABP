...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 13db4df7-1f01-4f6d-8633-5436392af19e
```

> `13db4df7-1f01-4f6d-8633-5436392af19e` is the password of the certificate, you can change it to any password you want.
